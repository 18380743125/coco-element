...
describe('createMessage', () => {
  test('调用方法应该创建对应的 Message 组件', async () => {
    ...
    expect(document.querySelector('.tt-message')).toBeTruthy()
    instance.destroy()
    await rAF()
    console.log('html2', document.body.innerHTML)
    expect(document.querySelector('.tt-message')).toBeFalsy()
  })
  ...
  test('多次调用方法应该创建多个实例', async () => {
    ...
    await rAF()
    const elements = document.querySelectorAll('.tt-message')
